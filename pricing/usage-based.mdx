...
**Aiployees **uses a **minutes-based** system for billing. These minutes (or tokens/credits) get **deducted** from your balance each time you make or receive a call. The actual “per-minute cost” depends on your plan, and **carrier costs** are also converted into minutes. Below is how it works.
...
> You’re on the **Lite Plan** with 100 included minutes:
>
> - If you make enough calls that total 80 AI minutes \+ carrier conversions = 80 used, you have 20 left this month.
> - Next month, you reset to 100. If you need 110 minutes, you pay for 10 extra minutes at your plan’s rate.

---

## 5. Volume Discounts or Tiers

- Plans vary (e.g., **Lite** at $0.39/min, **Boost**  at $0.32/min, **Grow** at $0.24/min).
...
### Example (Outbound Call, Grow Plan)

- **AI Rate**: $0.33/min
- **Call Duration**: 30 seconds → 0.5 AI minutes = $0.165 AI cost.
- **Carrier**: $0.01/min, but 30 seconds → 1 minute rounded up → $0.01.
  - $0.01 at your plan’s $0.33 rate = 0.0303 “plan minutes” used (Or if you do a simpler approach, $0.01 / $0.33 = 0.05 minutes)
- **Total**: 0.5 (AI) \+ 0.0303 (carrier) = 0.5303 minutes from your plan. If you had 1200 included, you’d have 1199.47 left.
