...
title: "Cost Overview"
icon: "dollar-sign"
description: "Understand the main components of Aiployees pricing, including call minutes, number rentals, and optional fees"
---

- Aiployees uses a **credit/minute system** to track usage for both AI processing and carrier network fees. Here's how it breaks down:
...
1. **AI Cost**
   ...
   - Rate depends on your plan (Lite, Boost, Grow, Scale etc.).
2. **Carrier Cost**
...
1. **Pick a Plan**: Decide on Lite, Boost, Grow, Scale—higher plans have cheaper AI rates.
2. **Acquire or Verify a Number**: Rent from Aiployees or add your own as caller ID for outbound.
