...
title: "Core Concepts"
icon: "lightbulb"
description: "Learn the fundamental building blocks of Aiployees, including system prompts, voices, and AI assistants"
---

Welcome to the fundamentals of Aiployees. Here, we explore the essential building blocks that you need to understand before configuring your AI assistant and calls.
...
- Aiployees integrates with **ElevenLabs** voices for natural-sounding speech.
