...
icon: "book"
description: "Essential terms and concepts you need to know to use Aiployees effectively"
---

Understanding these terms will help you navigate Aiployees more easily:
...
Aiployees built-in workflow platform, similar to Zapier/Make. It lets you connect triggers (like "call ended") to actions (like "send an email" or "update a Google Sheet") without writing code. [Learn more about automating your workflows](/automation).
