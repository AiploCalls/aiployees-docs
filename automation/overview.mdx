...
description: "Learn about Aiployees's built-in automation engine for creating workflows without coding"
---
...
Aiployees includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Aiployees (e.g., "call ended," "inbound call context injection").
