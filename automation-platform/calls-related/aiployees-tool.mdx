---
title: "Aiployees Tool"
icon: "phone"
description: "Learn how to use Aiployees triggers and actions in your AI calling flows"
---

# Aiployees Tool

The Aiployees tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the Aiployees tool prominently displayed at the top of the searching sidebar when looking for either triggers or actions.
</Note>
